...
namespace NLayer.Service.Services
{
    public class Service<T> : IService<T> where T : class
    {
        ...
        {
            return await _repository.GetAll().ToListAsync(); //toList ile beraber db den datayı aldık geriye döndük
        }
        ...
        public async Task RemoveAsync(T entity)  //bunlar normalde repo da async değildi unitofwork async olduğu için yapıyoruz.
        {
