    ...
    public partial class first_mig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 6, 16, 19, 51, 20, 745, DateTimeKind.Local).AddTicks(9750), "Kalem 1", 100m, 20, null },
                    { 2, 1, new DateTime(2023, 6, 16, 19, 51, 20, 745, DateTimeKind.Local).AddTicks(9758), "Kalem 2", 200m, 30, null },
                    { 3, 1, new DateTime(2023, 6, 16, 19, 51, 20, 745, DateTimeKind.Local).AddTicks(9759), "Kalem 3", 600m, 60, null },
                    { 4, 2, new DateTime(2023, 6, 16, 19, 51, 20, 745, DateTimeKind.Local).AddTicks(9760), "Kitap 1", 150m, 70, null },
                    { 5, 2, new DateTime(2023, 6, 16, 19, 51, 20, 745, DateTimeKind.Local).AddTicks(9761), "Kitap 2", 350m, 320, null }
                });
